...
import {BsChevronRight , BsSearch,BsFillCaretDownFill} from 'react-icons/bs'
...
const Navsm=()=>{
 return(
  ...
  <div className='text-white flex justify-between'>
   <div>
    <h4 className='text-xl font-bold'>It's All Start Here !</h4>
    <span className='text-gray-400 text-xs items-center flex'>Hyderabad <BsChevronRight/></span>
   </div>
   <div className='w-8 h-8'>
   <BsSearch className='w-full h-full'/></div>
  </div>
  </>
 )
}
const Navmd=()=>{
 return(
 <>
 <div className='w-full items-center flex bg-white gap-3 rounded px-3 py-2'>
   <BsSearch/>
  <input type='search' 
...
const Navbar = () => {
  return (
    <>
    <nav className='bg-bmsNav-800 p-5'>
    {/* Mobile devices */}
